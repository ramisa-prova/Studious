...
<header class="header">
   ...
   <section class="flex">
      ...
      <!-- admin header button logics profile, login , register, logout -->
      ...
      <div class="profile">
         ...
         <a href="../welcome.php" class="delete-btn">logout</a>
         <?php
            }else{
         ?>
...
<div class="side-bar">
   ...
   <div class="profile">
         ...
         <h3>please login or register</h3>
          <div class="flex-btn">
            <a href="login.php" class="option-btn">login</a>
            <a href="register.php" class="option-btn">register</a>
            <a href="../login.php" class="option-btn">Student wccount</a>
         </div>
         <?php
            }
         ?>
   ...
   <nav class="navbar">
      ...
      <a href="../welcome.php"><i class="fas fa-right-from-bracket"></i><span>logout</span></a>
   </nav>
